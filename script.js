...
document.addEventListener('DOMContentLoaded', function() {
  ...
  { value: "K044", label: "Perser / Colourpoint / Himalayan / Maskenperser" },
  ...
  { value: "H328", label: "Basset Bleu de Gascogne (Basset der Gascogne, Blauer)" },
  { value: "H329", label: "Basset d'Artois" },
  { value: "H330", label: "Basset Fauve de Bretagne" },
  { value: "H013", label: "Basset Griffon" },
  { value: "H333", label: "Basset Griffon Vendéen, Grand (B.G.V., Großer)" },
  { value: "H332", label: "Basset Griffon Vendéen, Petit  (B.G.V., Kleiner)" },
  ...
  { value: "H349", label: "Berger de Pyrènèes á face rase (Pyrenäen-Schäferhund mit kurzhaarigem Gesicht)" },
  { value: "H020", label: "Berger des Pyrénées" },
  { value: "H350", label: "Berger des Pyrénées á poil long (Langhaariger Pyrenäen-Schäferhund, Pyrenäenschäferhund, Langhaariger, Schäferhund, Langhaariger Pyrenäen-)" },
  ...
  { value: "H446", label: "Bordeauxdogge (Dogge, Bordeaux-, Dogge de Bordeaux)" },
  ...
  { value: "H375", label: "Bracke, Alpenländische Dachs- (Bracke, Alpine Dachs-, Bracke, Alpenländische-Erzgebirgische Dachs-, Bracke, Österreichische Dachs-)" },
  ...
  { value: "H372", label: "Bracke, Französische (Braque francais (type Gascogne/type Pyrénées)" },
  ...
  { value: "H918", label: "Bracke, Polnische (Ogar Polski, Polish Hound, Brachet polonais, Sabueso polaco)" },
  ...
  { value: "H379", label: "Bulldogge, Englische (Bulldog, English, Bully, Bulldogge, kleine englische)" },
  ...
  { value: "H318", label: "Bärenhund, Karelischer (Karjalankarhukoira, Bear Dog, Karelian, Bear Laika, Karelian, Björnhund)" },
  ...
  { value: "H470", label: "Cao de Fila, Dogge, Brasilianische, Mastiff, Brasilianischer" },
  ...
  { value: "H445", label: "Dogge, Deutsche (Dogge, Dänische, Dogge, Ulmer, Dogge, Englische, Hatzrüde, Saupacker, Dogge, Große)" },
  ...
  { value: "H558", label: "Francais blanc et noir (Laufhund, Französischer Weiss-Schwarzer-)" },
  { value: "H559", label: "Francais blanc et orange (Laufhund, Französischer Weiss-Oranger-)" },
  { value: "H557", label: "Francais tricolore (Laufhund, Französischer Dreifarbiger)" },
  ...
  { value: "H482", label: "Griffon bleu de Gascogne (Gascogne Griffon, Blauer)" },
  { value: "H492", label: "Griffon Bruxellois" },
  { value: "H483", label: "Griffon Fauve de Bretagne" },
  { value: "H484", label: "Griffon Korthals (Vorstehhund, Französischer Rauhhaariger, Griffon d'arrét á poil dur, Korthals, Griffon á poil dur)" },
  { value: "H485", label: "Griffon Nivernais (Grand Griffon Nivernais, Chien de Pays)" },
  { value: "H487", label: "Griffon Vendéen (Griffon Vendéen, Grand, Griffon Vendéen, Großer, Griffon Vendéen, Briquet)" },
  { value: "H486", label: "Griffon á poil Laineux (Griffon Boulet, Griffon, Französischer Wollhaariger, Griffon, French Wolly-haired Pointing, Grifón de muestra de pelo lanoso Francés)" },
  ...
  { value: "H554", label: "Lapphund, Finnischer  (Suomenlapinkoira, Lapinkoira)" },
  { value: "H555", label: "Lapphund, Schwedischer  (Lappenspitz, Spitz, Lappen-)" },
  { value: "H556", label: "Lapplandhirtenhund, Finnischer  (Rentierhund, Lappländischer, Lapinporoika)" },
  ...
  { value: "H608", label: "Nackthund, Chinesischer (Schopfhund, Chinesischer, Chinese crested dog)" },
  { value: "H609", label: "Nackthund, Mexikanischer (Mexican hairless, Xoloitzcuintli, Tepeizeuntli)" },
  { value: "H610", label: "Nackthund, Peruanischer (Perro sin pelo del peru, Nackthund, Inka-)" },
  ...
  { value: "H625", label: "Perdiguero (Hühnerhund/Vorstehhund) von Burgos" },
  ...
  { value: "H645", label: "Podenco Canario (Podenco, Kanarischer, Windhund, Kanarischer, Canarian Warren Hound)" },
  { value: "H646", label: "Podenco Ibicenco (Podenco, Ibiza-, Ibizian Hound, Mallorquin, Xarnelo, Mayorquais, Charnegue, Charnegui, Balearen-Hund)" },
  ...
  { value: "H648", label: "Podengo, Portugiesischer (großer/mittelgroßer)" },
  ...
  { value: "H665", label: "Rauhbart, Böhmischer (Cesky fousek, Vorstehhund, Tschechischer)" },
  { value: "H664", label: "Rauhbart, Slowakischer (Slowensky hrubosrsty stavac, Ohar, Vorstehhund, Slowakischer, Vorstehhund, Slowakischer Drahthaariger)" },
  ...
  { value: "H919", label: "Schwarzwildbracke, Slowakische (Slovensky Kopov, Slowakischer Laufhund)" },
  ...
  { value: "H888", label: "Schäferhund, Bosnisch-Herzegowinischer und kroatischer" },
  ...
  { value: "H753", label: "Sennenhund, Appenzeller  (Appenzellerhund, Appezöller Bläss)" },
  { value: "H754", label: "Sennenhund, Berner (Dürrbächler)" },
  { value: "H755", label: "Sennenhund, Entlebucher" },
  { value: "H756", label: "Sennenhund, Großer Schweizer (Great Swiss Mountain Dog, Grand bouvier suisse)" },
  { value: "H385", label: "Serra da Estrela Berghund" },
  { value: "H206", label: "Setter" },
  { value: "H757", label: "Setter, English (Setter, Englischer, Setter, Laverack, Setter, Llewellin)" },
  { value: "H758", label: "Setter, Gordon" },
  { value: "H760", label: "Setter, Irish Red (Setter, Irischer Roter, Setter, Irish, Setter, Red)" },
  { value: "H759", label: "Setter, Irish Red and White (Setter, Irischer Rot-Weißer, Setter, Parti-coloured)" },
  ...
  { value: "H803", label: "Spitze, Deutsche: Spitz, Wolfs (Keeshond, Chien Loup)" },
  ...
  { value: "H420", label: "Waschbärenhund, (Amerikanischer) Schwarz-Lohfarbener" },
